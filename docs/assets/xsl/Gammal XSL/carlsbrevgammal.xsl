...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
            ...
            <body>
                ...
                <nav id="sitenav">
                    <a href="index.html">Hem</a> | <a href="karleksbreven.html">Kärleksbreven</a> |
                        ...
                        href="carlsbrev.html">Carls brev</a> | <a href="historia.html">Historian
                        runt breven</a> | <a href="personer.html">Personerna bakom breven</a>
                </nav>
                <nav id="brevnav">
                    <a href="index.html">3/11-1930: Brev från Carl</a> | <a
                        href="karleksbreven.html">3/11-1930: Brev från Carl</a> | <a
                        href="aktenskapsbreven.html">3/11-1930: Brev från Carl</a> | <a
                        href="aktenskapsbreven.html">3/11-1930: Brev från Carl</a> | <a
                        href="carlsbrev.html">3/11-1930: Brev från Carl</a> | <a
                        href="historia.html">3/11-1930: Brev från Carl</a>
                </nav>
    ...
    <xsl:template match="tei:seg[@type = 'leftMargin'][@subtype = 'sideways']">
        <p/>
        <p/> [VÄNSTERMARGINALEN] </xsl:template>

    <xsl:template match="tei:seg[@type = 'upperMargin'][@subtype = 'upsideDown']">
        <p/>
        <p/> [ÖVERMARGINALENEN] </xsl:template>
